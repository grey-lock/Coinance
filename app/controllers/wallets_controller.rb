class WalletsController < ApplicationController
  ...
  def wallet_params
    params.require(:wallet).permit(:name, :coin_amount, :user_deposit, :net_value, :coin_id, coin: [:name, :symbol, :last_known_value], transaction_attributes: [:user_id, :amount, :quantity, :price_per_coin, :fee])
  end
